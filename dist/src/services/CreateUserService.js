...
var CreateUserService = /** @class */ (function () {
    ...
    CreateUserService.prototype.execute = function (_a) {
        var name = _a.name, surname = _a.surname, email = _a.email, password = _a.password, confirm_password = _a.confirm_password;
        return __awaiter(this, void 0, void 0, function () {
            var userRepository, checkUserExists, user, _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        _e.sent();
                        if (user) {
                            return [2 /*return*/, { status: 'ok', statusCode: "201" }];
                        }
                        else {
                            return [2 /*return*/, { status: 'error', statusCode: "400" }];
                        }
                        return [2 /*return*/];
                }
            });
